...
public enum Building {
    ...
    MANA_POOLS("Mana pool descr.",5,false,new MaintenanceBuilder(Resource.WOOD,0.15).build(),Resource.MANA, Collections.emptyList()),
    ...
    DRAGON_PIT("Dragon pit descr.",5,false,new MaintenanceBuilder(Resource.WOOD,0.25).build(),null, Arrays.asList(Unit.DRAGON_RIDER)),
    ...
    HOUSE_OF_INVENTORS("House of inventors descr.",5,false,new MaintenanceBuilder(Resource.WOOD,0.2).build(),Resource.RESEARCH_POINT, Collections.emptyList()),
    BUILDERS_WORKSHOP("Builders workshop descr.",5,false,new MaintenanceBuilder(Resource.WOOD,0.3).build(),Resource.POINT_OF_CONSTRUCTION, Collections.emptyList());
